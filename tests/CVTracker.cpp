...
TEST_CASE( "Track_Video", "[libopenshot][opencv][tracker]" )
{
    ...
    CHECK(x == Catch::Detail::Approx(256).margin(1));
    CHECK(y == Catch::Detail::Approx(132).margin(1));
    CHECK(width == Catch::Detail::Approx(180).margin(1));
    CHECK(height == Catch::Detail::Approx(166).margin(2));
}
...
TEST_CASE( "SaveLoad_Protobuf", "[libopenshot][opencv][tracker]" )
{
    ...
    CHECK(x_1 == Catch::Detail::Approx(x_2).margin(0.01));
    CHECK(y_1 == Catch::Detail::Approx(y_2).margin(0.01));
    CHECK(width_1 == Catch::Detail::Approx(width_2).margin(0.01));
    CHECK(height_1 == Catch::Detail::Approx(height_2).margin(0.01));
