...
TEST_CASE( "default constructor", "[libopenshot][coordinate]" )
{
	...
	CHECK(c1.X == Catch::Detail::Approx(0.0f).margin(0.00001));
	CHECK(c1.Y == Catch::Detail::Approx(0.0f).margin(0.00001));
}
...
TEST_CASE( "XY constructor", "[libopenshot][coordinate]" )
{
	...
	CHECK(c1.X == Catch::Detail::Approx(2.0f).margin(0.00001));
	CHECK(c1.Y == Catch::Detail::Approx(8.0f).margin(0.00001));
}

TEST_CASE( "std::pair constructor", "[libopenshot][coordinate]" )
{
	Coordinate c1(std::pair<double,double>(12, 10));
	CHECK(c1.X == Catch::Detail::Approx(12.0f).margin(0.00001));
	CHECK(c1.Y == Catch::Detail::Approx(10.0f).margin(0.00001));
}
...
TEST_CASE( "SetJson", "[libopenshot][coordinate]" ) {
	...
	CHECK(c.X == Catch::Detail::Approx(100.0).margin(0.01));
	CHECK(c.Y == Catch::Detail::Approx(50.0).margin(0.01));
}
