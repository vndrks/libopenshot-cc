...
TEST_CASE( "std::pair ctor", "[libopenshot][point]" )
{
	...
	CHECK(p1.co.X == Catch::Detail::Approx(22.0f).margin(0.00001));
	CHECK(p1.co.Y == Catch::Detail::Approx(5.0f).margin(0.00001));
}
...
TEST_CASE( "Coordinate ctor", "[libopenshot][point]" )
{
	...
	CHECK(p1.co.X == Catch::Detail::Approx(3.0f).margin(0.00001));
	CHECK(p1.co.Y == Catch::Detail::Approx(7.0f).margin(0.00001));
	CHECK(p1.interpolation == openshot::InterpolationType::BEZIER);
}
