...
TEST_CASE( "Webm", "[libopenshot][ffmpegwriter]" )
{
	...
	CHECK((int)pixels[pixel_index] == Catch::Detail::Approx(23).margin(7));
	CHECK((int)pixels[pixel_index + 1] == Catch::Detail::Approx(23).margin(7));
	CHECK((int)pixels[pixel_index + 2] == Catch::Detail::Approx(23).margin(7));
	CHECK((int)pixels[pixel_index + 3] == Catch::Detail::Approx(255).margin(7));
}
