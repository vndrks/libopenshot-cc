...
TEST_CASE( "Constructors", "[libopenshot][fraction]" )
{
	...
	CHECK(f1.num == 1);
	CHECK(f1.den == 1);
	CHECK(f1.ToFloat() == Catch::Detail::Approx(1.0f).margin(0.00001));
	CHECK(f1.ToDouble() == Catch::Detail::Approx(1.0f).margin(0.00001));
...
TEST_CASE( "Alt_Constructors", "[libopenshot][fraction]" )
{
	...
	CHECK(f1.num == 24);
	CHECK(f1.den == 1);
	CHECK(f1.ToFloat() == Catch::Detail::Approx(24.0f).margin(0.00001));

	// Use the delegating constructor for std::vector
	std::vector<int> v{30000, 1001};
	Fraction f2(v);
	CHECK(f2.ToFloat() == Catch::Detail::Approx(30000.0/1001.0).margin(0.00001));
	...
	CHECK(f3.den == 1001);
	CHECK(f3.num == 24000);
	CHECK(f3.Reciprocal().ToFloat() == Catch::Detail::Approx(1001.0/24000.0).margin(0.00001));
}
...
TEST_CASE( "WxH_640_480", "[libopenshot][fraction]" )
{
	...
	CHECK(f1.num == 640);
	CHECK(f1.den == 480);
	CHECK(f1.ToFloat() == Catch::Detail::Approx(1.33333f).margin(0.00001));
	CHECK(f1.ToDouble() == Catch::Detail::Approx(1.33333f).margin(0.00001));
...
TEST_CASE( "WxH_1280_720", "[libopenshot][fraction]" )
{
	...
	CHECK(f1.num == 1280);
	CHECK(f1.den == 720);
	CHECK(f1.ToFloat() == Catch::Detail::Approx(1.77777f).margin(0.00001));
	CHECK(f1.ToDouble() == Catch::Detail::Approx(1.77777f).margin(0.00001));
...
TEST_CASE( "Reciprocal", "[libopenshot][fraction]" )
{
	...
	CHECK(f2.num == 720);
	CHECK(f2.den == 1280);
	CHECK(f2.ToFloat() == Catch::Detail::Approx(0.5625f).margin(0.00001));
	CHECK(f2.ToDouble() == Catch::Detail::Approx(0.5625f).margin(0.00001));
...
TEST_CASE( "Numeric multiplication", "[libopenshot][fraction]" )
{
    ...
    CHECK(f1 * num2 == Catch::Detail::Approx(static_cast<double>(f1.ToDouble() * num2))
                       .margin(0.0001));
    CHECK(f1 * num3 == Catch::Detail::Approx(static_cast<float>(f1.ToDouble() * num3))
                       .margin(0.0001));
    ...
    CHECK(num2 * f1 == Catch::Detail::Approx(static_cast<double>(f1.ToDouble() * num2))
                       .margin(0.0001));
    CHECK(num3 * f1 == Catch::Detail::Approx(static_cast<float>(f1.ToDouble() * num3))
                       .margin(0.0001));
    ...
    CHECK(num2 * f1 == Catch::Detail::Approx(f1 * num2).margin(0.0001));
    CHECK(num3 * f1 == Catch::Detail::Approx(f1 * num3).margin(0.0001));
...
TEST_CASE( "Numeric division", "[libopenshot][fraction]" )
{
    ...
    CHECK(f2 / num2 == Catch::Detail::Approx(static_cast<double>(f2.ToDouble() / num2))
                       .margin(0.0001));
    CHECK(f2 / num3 == Catch::Detail::Approx(static_cast<float>(f2.ToDouble() / num3))
                       .margin(0.0001));
    CHECK(f2 / num4 == static_cast<int>(f2.ToDouble() / num4));

    // operator* with Fraction on RHS
    CHECK(num1 / f1 == static_cast<int64_t>(num1 / f1.ToDouble()));
    CHECK(num2 / f1 == Catch::Detail::Approx(static_cast<double>(num2 / f1.ToDouble()))
                       .margin(0.0001));
    CHECK(num3 / f1 == Catch::Detail::Approx(static_cast<float>(num3 / f1.ToDouble()))
                       .margin(0.0001));
    CHECK(num4 / f1 == static_cast<int>(num4 / f1.ToDouble()));

    CHECK(num1 / f2 == static_cast<int64_t>(num1 / f2.ToDouble()));
    CHECK(num2 / f2 == Catch::Detail::Approx(static_cast<double>(num2 / f2.ToDouble()))
                       .margin(0.0001));
    CHECK(num3 / f2 == Catch::Detail::Approx(static_cast<float>(num3 / f2.ToDouble()))
                       .margin(0.0001));
