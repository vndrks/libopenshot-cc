...
TEST_CASE( "Check_Audio_File", "[libopenshot][ffmpegreader]" )
{
	...
	CHECK(samples[0] == Catch::Detail::Approx(0.0f).margin(0.00001));
	CHECK(samples[50] == Catch::Detail::Approx(0.0f).margin(0.00001));
	CHECK(samples[100] == Catch::Detail::Approx(0.0f).margin(0.00001));
	CHECK(samples[200] == Catch::Detail::Approx(0.0f).margin(0.00001));
	CHECK(samples[230] == Catch::Detail::Approx(0.16406f).margin(0.00001));
	CHECK(samples[300] == Catch::Detail::Approx(-0.06250f).margin(0.00001));
...
TEST_CASE( "Check_Video_File", "[libopenshot][ffmpegreader]" )
{
	...
	CHECK((int)pixels[pixel_index] == Catch::Detail::Approx(21).margin(5));
	CHECK((int)pixels[pixel_index + 1] == Catch::Detail::Approx(191).margin(5));
	CHECK((int)pixels[pixel_index + 2] == Catch::Detail::Approx(0).margin(5));
	CHECK((int)pixels[pixel_index + 3] == Catch::Detail::Approx(255).margin(5));
	...
	// Check image properties on scanline 10, pixel 112
	CHECK((int)pixels[pixel_index] == Catch::Detail::Approx(0).margin(5));
	CHECK((int)pixels[pixel_index + 1] == Catch::Detail::Approx(96).margin(5));
	CHECK((int)pixels[pixel_index + 2] == Catch::Detail::Approx(188).margin(5));
	CHECK((int)pixels[pixel_index + 3] == Catch::Detail::Approx(255).margin(5));
...
TEST_CASE( "Decoding AV1 Video", "[libopenshot][ffmpegreader]" )
{
	try {
		...
		// Check image properties on scanline 10, pixel 112
		CHECK((int) pixels[pixel_index] == Catch::Detail::Approx(0).margin(5));
		CHECK((int) pixels[pixel_index + 1] == Catch::Detail::Approx(0).margin(5));
		CHECK((int) pixels[pixel_index + 2] == Catch::Detail::Approx(0).margin(5));
		CHECK((int) pixels[pixel_index + 3] == Catch::Detail::Approx(255).margin(5));
		...
		CHECK((int) pixels[pixel_index] == Catch::Detail::Approx(255).margin(5));
		CHECK((int) pixels[pixel_index + 1] == Catch::Detail::Approx(255).margin(5));
		CHECK((int) pixels[pixel_index + 2] == Catch::Detail::Approx(255).margin(5));
		CHECK((int) pixels[pixel_index + 3] == Catch::Detail::Approx(255).margin(5));
