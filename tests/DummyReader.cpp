...
TEST_CASE( "Fake_Frame", "[libopenshot][dummyreader]" ) {
	...
	CHECK(r.GetFrame(1)->GetAudioSamples(0)[1] == Catch::Detail::Approx(1.00068033).margin(0.00001));
	CHECK(r.GetFrame(1)->GetAudioSamples(0)[2] == Catch::Detail::Approx(1.00136054).margin(0.00001));
	CHECK(r.GetFrame(2)->GetAudioSamples(0)[0] == 2);
	CHECK(r.GetFrame(2)->GetAudioSamples(0)[1] == Catch::Detail::Approx(2.00068033).margin(0.00001));
	CHECK(r.GetFrame(2)->GetAudioSamples(0)[2] == Catch::Detail::Approx(2.00136054).margin(0.00001));
