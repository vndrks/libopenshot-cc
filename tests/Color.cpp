...
TEST_CASE( "default constructor", "[libopenshot][color]" )
{
	...
	CHECK(c1.red.GetValue(0) == Catch::Detail::Approx(0.0f).margin(0.00001));
	CHECK(c1.green.GetValue(0) == Catch::Detail::Approx(0.0f).margin(0.00001));
	CHECK(c1.blue.GetValue(0) == Catch::Detail::Approx(0.0f).margin(0.00001));
}
...
TEST_CASE( "Keyframe constructor", "[libopenshot][color]" )
{
	...
	CHECK(c.red.GetLong(100) == Catch::Detail::Approx(20).margin(0.01));
	CHECK(c.green.GetLong(100) == Catch::Detail::Approx(40).margin(0.01));
	CHECK(c.blue.GetLong(100) == Catch::Detail::Approx(60).margin(0.01));
	CHECK(c.alpha.GetLong(100) == Catch::Detail::Approx(80).margin(0.01));
}
...
TEST_CASE( "Animate_Colors", "[libopenshot][color]" )
{
	...
	CHECK(c1.red.GetLong(500) == Catch::Detail::Approx(0).margin(0.01));
	CHECK(c1.green.GetLong(500) == Catch::Detail::Approx(187).margin(0.01));
	CHECK(c1.blue.GetLong(500) == Catch::Detail::Approx(160).margin(0.01));
}
...
TEST_CASE( "QColor ctor", "[libopenshot][color]" )
{
    ...
    CHECK(c.red.GetLong(1) == Catch::Detail::Approx(255.0).margin(0.0001));
    CHECK(c.green.GetLong(1) == Catch::Detail::Approx(0.0).margin(0.0001));
    CHECK(c.blue.GetLong(1) == Catch::Detail::Approx(0.0).margin(0.0001));
    CHECK(c.alpha.GetLong(1) == Catch::Detail::Approx(255.0).margin(0.0001));
}
...
TEST_CASE( "SetJson", "[libopenshot][color]" ) {
	...
	CHECK(c.red.GetLong(10) == Catch::Detail::Approx(0).margin(0.01));
	CHECK(c.green.GetLong(10) == Catch::Detail::Approx(128).margin(0.01));
	CHECK(c.blue.GetLong(10) == Catch::Detail::Approx(64).margin(0.01));
	CHECK(c.alpha.GetLong(10) == Catch::Detail::Approx(192).margin(0.01));
}
