...
TEST_CASE( "caption effect", "[libopenshot][caption]" )
{
    ...
    SECTION("default constructor") {
        ...
        CHECK(c1.background_alpha.GetValue(1) == Catch::Detail::Approx(0.0f).margin(0.00001));
        CHECK(c1.left.GetValue(1) == Catch::Detail::Approx(0.10f).margin(0.00001));
        CHECK(c1.right.GetValue(1) == Catch::Detail::Approx(0.10f).margin(0.00001));
        CHECK(c1.top.GetValue(1) == Catch::Detail::Approx(0.75).margin(0.00001));
        CHECK(c1.stroke_width.GetValue(1) == Catch::Detail::Approx(0.5f).margin(0.00001));
        CHECK(c1.font_size.GetValue(1) == Catch::Detail::Approx(30.0f).margin(0.00001));
        CHECK(c1.font_alpha.GetValue(1) == Catch::Detail::Approx(1.0f).margin(0.00001));
        CHECK(c1.font_name == "sans");
        CHECK(c1.fade_in.GetValue(1) == Catch::Detail::Approx(0.35f).margin(0.00001));
        CHECK(c1.fade_out.GetValue(1) == Catch::Detail::Approx(0.35f).margin(0.00001));
        CHECK(c1.background_corner.GetValue(1) == Catch::Detail::Approx(10.0f).margin(0.00001));
        CHECK(c1.background_padding.GetValue(1) == Catch::Detail::Approx(20.0f).margin(0.00001));
        CHECK(c1.line_spacing.GetValue(1) == Catch::Detail::Approx(1.0f).margin(0.00001));
