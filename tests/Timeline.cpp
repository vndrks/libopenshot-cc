...
TEST_CASE( "Framerate", "[libopenshot][timeline]" )
{
	...
	// Check values
	CHECK(t1.info.fps.ToFloat() == Catch::Detail::Approx(24.0f).margin(0.00001));
}
...
TEST_CASE( "two-track video", "[libopenshot][timeline]" )
{
	...
	CHECK((int)f->GetPixels(pixel_row)[pixel_index] == Catch::Detail::Approx(21).margin(5));
	CHECK((int)f->GetPixels(pixel_row)[pixel_index + 1] == Catch::Detail::Approx(191).margin(5));
	CHECK((int)f->GetPixels(pixel_row)[pixel_index + 2] == Catch::Detail::Approx(0).margin(5));
	CHECK((int)f->GetPixels(pixel_row)[pixel_index + 3] == Catch::Detail::Approx(255).margin(5));

	f = t.GetFrame(2);

	// Check image properties
	CHECK((int)f->GetPixels(pixel_row)[pixel_index] == Catch::Detail::Approx(176).margin(5));
	CHECK((int)f->GetPixels(pixel_row)[pixel_index + 1] == Catch::Detail::Approx(0).margin(5));
	CHECK((int)f->GetPixels(pixel_row)[pixel_index + 2] == Catch::Detail::Approx(186).margin(5));
	CHECK((int)f->GetPixels(pixel_row)[pixel_index + 3] == Catch::Detail::Approx(255).margin(5));

	f = t.GetFrame(3);

	// Check image properties
	CHECK((int)f->GetPixels(pixel_row)[pixel_index] == Catch::Detail::Approx(23).margin(5));
	CHECK((int)f->GetPixels(pixel_row)[pixel_index + 1] == Catch::Detail::Approx(190).margin(5));
	CHECK((int)f->GetPixels(pixel_row)[pixel_index + 2] == Catch::Detail::Approx(0).margin(5));
	CHECK((int)f->GetPixels(pixel_row)[pixel_index + 3] == Catch::Detail::Approx(255).margin(5));
	...
	// Check image properties
	CHECK((int)f->GetPixels(pixel_row)[pixel_index] == Catch::Detail::Approx(20).margin(5));
	CHECK((int)f->GetPixels(pixel_row)[pixel_index + 1] == Catch::Detail::Approx(190).margin(5));
	CHECK((int)f->GetPixels(pixel_row)[pixel_index + 2] == Catch::Detail::Approx(0).margin(5));
	CHECK((int)f->GetPixels(pixel_row)[pixel_index + 3] == Catch::Detail::Approx(255).margin(5));
...
TEST_CASE( "Clip order", "[libopenshot][timeline]" )
{
	...
	for (auto clip : clips) {
		...
		case 1:
			CHECK(clip->Layer() == 1);
			CHECK(clip->Position() == Catch::Detail::Approx(0.0).margin(0.0001));
			break;
		case 2:
			CHECK(clip->Layer() == 1);
			CHECK(clip->Position() == Catch::Detail::Approx(0.5).margin(0.0001));
			break;
		case 3:
			CHECK(clip->Layer() == 2);
			break;
...
TEST_CASE( "Effect order", "[libopenshot][timeline]" )
{
	...
	for (auto effect : effects) {
		...
		case 1:
			...
			CHECK(effect->Id() == "B-1");
			CHECK(effect->Position() == Catch::Detail::Approx(0.0).margin(0.0001));
		...
		case 3:
			CHECK(effect->Layer() == 1);
			CHECK(effect->Id() == "B-2");
			CHECK(effect->Position() == Catch::Detail::Approx(0.5).margin(0.0001));
...
TEST_CASE( "GetMaxFrame and GetMaxTime", "[libopenshot][timeline]" )
{
	...
	CHECK(t.GetMaxTime() == Catch::Detail::Approx(95.0).margin(0.001));
	...
	CHECK(t.GetMaxTime() == Catch::Detail::Approx(155.0).margin(0.001));

	clip2.Start(20);
	CHECK(t.GetMaxFrame() == 135 * 30 + 1);
	CHECK(t.GetMaxTime() == Catch::Detail::Approx(135.0).margin(0.001));

	clip2.End(35);
	CHECK(t.GetMaxFrame() == 125 * 30 + 1);
	CHECK(t.GetMaxTime() == Catch::Detail::Approx(125.0).margin(0.001));

	t.RemoveClip(&clip1);
	CHECK(t.GetMaxFrame() == 115 * 30 + 1);
	CHECK(t.GetMaxTime() == Catch::Detail::Approx(115.0).margin(0.001));
	...
	CHECK(t.GetMaxTime() == Catch::Detail::Approx(10.0).margin(0.001));
	...
	CHECK(t.GetMaxTime() == Catch::Detail::Approx(20.0).margin(0.001));
}
...
TEST_CASE( "ApplyJSONDiff Update Reader Info", "[libopenshot][timeline]" )
{
	...
	CHECK(clip1.info.duration == Catch::Detail::Approx(51.94667).margin(0.00001));
	...
	CHECK(mapper->Reader()->info.duration == Catch::Detail::Approx(20.77867).margin(0.00001));
	...
	CHECK(clip1.info.video_timebase.num == 1);
	CHECK(clip1.info.video_timebase.den == 24);
	CHECK(clip1.info.duration == Catch::Detail::Approx(20.77867).margin(0.00001));
