...
TEST_CASE( "Extract waveform data piano.wav", "[libopenshot][audiowaveformer]" )
{
    ...
    for (auto channel = 0; channel < r.info.channels; channel++) {
        ...
        if (channel == 0) {
            ...
            CHECK(waveform.rms_samples[0] == Catch::Detail::Approx(0.04879f).margin(0.00001));
            CHECK(waveform.rms_samples[86] == Catch::Detail::Approx(0.13578f).margin(0.00001));
            CHECK(waveform.rms_samples[87] == Catch::Detail::Approx(0.0f).margin(0.00001));
        } else if (channel == 1) {
            CHECK(waveform.rms_samples.size() == 107);
            CHECK(waveform.rms_samples[0] == Catch::Detail::Approx(0.04879f).margin(0.00001));
            CHECK(waveform.rms_samples[86] == Catch::Detail::Approx(0.13578f).margin(0.00001));
...
TEST_CASE( "Extract waveform data sintel", "[libopenshot][audiowaveformer]" )
{
    ...
    for (auto channel = 0; channel < r.info.channels; channel++) {
        ...
        if (channel == 0) {
            ...
            CHECK(waveform.rms_samples[0] == Catch::Detail::Approx(0.00001f).margin(0.00001));
            CHECK(waveform.rms_samples[1037] == Catch::Detail::Approx(0.00003f).margin(0.00001));
            CHECK(waveform.rms_samples[1038] == Catch::Detail::Approx(0.0f).margin(0.00001));
        } else if (channel == 1) {
            CHECK(waveform.rms_samples.size() == 1058);
            CHECK(waveform.rms_samples[0] == Catch::Detail::Approx(0.00001f ).margin(0.00001));
            CHECK(waveform.rms_samples[1037] == Catch::Detail::Approx(0.00003f).margin(0.00001));
...
TEST_CASE( "Normalize & scale waveform data piano.wav", "[libopenshot][audiowaveformer]" )
{
    ...
    for (auto channel = 0; channel < r.info.channels; channel++) {
        ...
        if (channel == 0) {
            CHECK(waveform.rms_samples.size() == 107);
            CHECK(waveform.rms_samples[0] == Catch::Detail::Approx(0.07524f).margin(0.00001));
            CHECK(waveform.rms_samples[35] == Catch::Detail::Approx(0.20063f).margin(0.00001));
            CHECK(waveform.rms_samples[86] == Catch::Detail::Approx(0.2094f).margin(0.00001));
            CHECK(waveform.rms_samples[87] == Catch::Detail::Approx(0.0f).margin(0.00001));
        }
...
TEST_CASE( "AudioWaveformData struct methods", "[libopenshot][audiowaveformer]" )
{
    ...
    CHECK(waveform.rms_samples[0] == Catch::Detail::Approx(1.0f).margin(0.00001));
    CHECK(waveform.rms_samples[9] == Catch::Detail::Approx(1.0f).margin(0.00001));
    CHECK(waveform.max_samples[0] == Catch::Detail::Approx(1.0f).margin(0.00001));
    CHECK(waveform.max_samples[9] == Catch::Detail::Approx(1.0f).margin(0.00001));

    // Scale all values by 2
    waveform.scale(10, 2.0);
    CHECK(waveform.rms_samples.size() == 10);
    CHECK(waveform.max_samples.size() == 10);
    CHECK(waveform.rms_samples[0] == Catch::Detail::Approx(2.0f).margin(0.00001));
    CHECK(waveform.rms_samples[9] == Catch::Detail::Approx(2.0f).margin(0.00001));
    CHECK(waveform.max_samples[0] == Catch::Detail::Approx(2.0f).margin(0.00001));
    CHECK(waveform.max_samples[9] == Catch::Detail::Approx(2.0f).margin(0.00001));

    // Zero out all values
    waveform.zero(10);
    CHECK(waveform.rms_samples.size() == 10);
    CHECK(waveform.max_samples.size() == 10);
    CHECK(waveform.rms_samples[0] == Catch::Detail::Approx(0.0f).margin(0.00001));
    CHECK(waveform.rms_samples[9] == Catch::Detail::Approx(0.0f).margin(0.00001));
    CHECK(waveform.max_samples[0] == Catch::Detail::Approx(0.0f).margin(0.00001));
    CHECK(waveform.max_samples[9] == Catch::Detail::Approx(0.0f).margin(0.00001));
