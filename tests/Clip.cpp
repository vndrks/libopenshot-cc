...
TEST_CASE( "default constructor", "[libopenshot][clip]" )
{
	...
	CHECK(c1.Layer() == 0);
	CHECK(c1.Position() == Catch::Detail::Approx(0.0f).margin(0.00001));
	CHECK(c1.Start() == Catch::Detail::Approx(0.0f).margin(0.00001));
	CHECK(c1.End() == Catch::Detail::Approx(0.0f).margin(0.00001));
}
...
TEST_CASE( "path string constructor", "[libopenshot][clip]" )
{
	...
	CHECK(c1.Position() == Catch::Detail::Approx(0.0f).margin(0.00001));
	CHECK(c1.Start() == Catch::Detail::Approx(0.0f).margin(0.00001));
	CHECK(c1.End() == Catch::Detail::Approx(4.39937f).margin(0.00001));
}
...
TEST_CASE( "basic getters and setters", "[libopenshot][clip]" )
{
	...
	CHECK(c1.Layer() == 1);
	CHECK(c1.Position() == Catch::Detail::Approx(5.0f).margin(0.00001));
	CHECK(c1.Start() == Catch::Detail::Approx(3.5f).margin(0.00001));
	CHECK(c1.End() == Catch::Detail::Approx(10.5f).margin(0.00001));
}
...
TEST_CASE( "properties", "[libopenshot][clip]" )
{
	...
	CHECK(root["alpha"]["value"].asDouble() == Catch::Detail::Approx(1.0f).margin(0.01));
	...
	// Check for specific things
	CHECK(root["alpha"]["value"].asDouble() == Catch::Detail::Approx(0.5f).margin(0.01));
	...
	// Check for specific things
	CHECK(root["alpha"]["value"].asDouble() == Catch::Detail::Approx(0.0f).margin(0.00001));
	CHECK(root["alpha"]["keyframe"].asBool() == true);
...
TEST_CASE( "access frames past reader length", "[libopenshot][clip]" )
{
	...
	CHECK(frame->GetAudioSamples(0)[0] == Catch::Detail::Approx(30.0).margin(0.00001));
	CHECK(frame->GetAudioSamples(0)[600] == Catch::Detail::Approx(30.4081631).margin(0.00001));
	CHECK(frame->GetAudioSamples(0)[1200] == Catch::Detail::Approx(30.8163261).margin(0.00001));

	// Get the +1 past the end of the reader (should be audio silence)
	frame = c1.GetFrame(31);

	CHECK(frame->GetAudioSamples(0)[0] == Catch::Detail::Approx(0.0).margin(0.00001));
	CHECK(frame->GetAudioSamples(0)[600] == Catch::Detail::Approx(0.0).margin(0.00001));
	CHECK(frame->GetAudioSamples(0)[1200] == Catch::Detail::Approx(0.0).margin(0.00001));
