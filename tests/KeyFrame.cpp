...
TEST_CASE( "GetPoint (1 Point)", "[libopenshot][keyframe]" )
{
	...
	CHECK(k1.GetCount() == 1);
	CHECK(k1.GetPoint(0).co.X == Catch::Detail::Approx(2.0f).margin(0.00001));
	CHECK(k1.GetPoint(0).co.Y == Catch::Detail::Approx(3.0f).margin(0.00001));
	CHECK_THROWS_AS(k1.GetPoint(1), OutOfBoundsPoint);
}
...
TEST_CASE( "AddPoint (2 Points)", "[libopenshot][keyframe]" )
{
	...
	CHECK(k1.GetPoint(0).co.X == Catch::Detail::Approx(2.0f).margin(0.00001));
	CHECK(k1.GetPoint(1).co.X == Catch::Detail::Approx(5.0f).margin(0.00001));
	CHECK_THROWS_AS(k1.GetPoint(-1), OutOfBoundsPoint);
...
TEST_CASE( "GetValue (Bezier curve, 2 Points)", "[libopenshot][keyframe]" )
{
	...
	CHECK(kf.GetValue(-1) == Catch::Detail::Approx(1.0f).margin(0.0001));
	CHECK(kf.GetValue(0) == Catch::Detail::Approx(1.0f).margin(0.0001));
	CHECK(kf.GetValue(1) == Catch::Detail::Approx(1.0f).margin(0.0001));
	CHECK(kf.GetValue(9) == Catch::Detail::Approx(1.12414f).margin(0.0001));
	CHECK(kf.GetValue(20) == Catch::Detail::Approx(1.86370f).margin(0.0001));
	CHECK(kf.GetValue(40) == Catch::Detail::Approx(3.79733f).margin(0.0001));
	CHECK(kf.GetValue(50) == Catch::Detail::Approx(4.0f).margin(0.0001));
...
TEST_CASE( "GetValue (Bezier, 5 Points, 40% handle)", "[libopenshot][keyframe]" )
{
	...
	// Spot check values from the curve
	CHECK(1.0f == Catch::Detail::Approx(kf.GetValue(-1)).margin(0.0001));
	CHECK(kf.GetValue(0) == Catch::Detail::Approx(1.0f).margin(0.0001));
	CHECK(kf.GetValue(1) == Catch::Detail::Approx(1.0f).margin(0.0001));
	CHECK(kf.GetValue(27) == Catch::Detail::Approx(2.68197f).margin(0.0001));
	CHECK(kf.GetValue(77) == Catch::Detail::Approx(7.47719f).margin(0.0001));
	CHECK(kf.GetValue(127) == Catch::Detail::Approx(4.20468f).margin(0.0001));
	CHECK(kf.GetValue(177) == Catch::Detail::Approx(1.73860f).margin(0.0001));
	CHECK(kf.GetValue(200) == Catch::Detail::Approx(3.0f).margin(0.0001));
	// Check the expected number of values
...
TEST_CASE( "GetValue (Linear, 3 Points)", "[libopenshot][keyframe]" )
{
	...
	CHECK(kf.GetValue(0) == Catch::Detail::Approx(1.0f).margin(0.0001));
	CHECK(kf.GetValue(1) == Catch::Detail::Approx(1.0f).margin(0.0001));
	CHECK(kf.GetValue(9) == Catch::Detail::Approx(3.33333f).margin(0.0001));
	CHECK(kf.GetValue(20) == Catch::Detail::Approx(6.54167f).margin(0.0001));
	CHECK(kf.GetValue(40) == Catch::Detail::Approx(4.4f).margin(0.0001));
	CHECK(kf.GetValue(50) == Catch::Detail::Approx(2.0f).margin(0.0001));
	// Check the expected number of values
	CHECK(kf.GetLength() == 50);
}
...
TEST_CASE( "GetValue (Constant, 3 Points)", "[libopenshot][keyframe]" )
{
	...
	CHECK(kf.GetValue(0) == Catch::Detail::Approx(1.0f).margin(0.0001));
	CHECK(kf.GetValue(1) == Catch::Detail::Approx(1.0f).margin(0.0001));
	CHECK(kf.GetValue(24) == Catch::Detail::Approx(1.0f).margin(0.0001));
	CHECK(kf.GetValue(25) == Catch::Detail::Approx(8.0f).margin(0.0001));
	CHECK(kf.GetValue(40) == Catch::Detail::Approx(8.0f).margin(0.0001));
	CHECK(kf.GetValue(49) == Catch::Detail::Approx(8.0f).margin(0.0001));
	CHECK(kf.GetValue(50) == Catch::Detail::Approx(2.0f).margin(0.0001));
	// Check the expected number of values
	CHECK(kf.GetLength() == 50);
}
...
TEST_CASE( "GetDelta", "[libopenshot][keyframe]" )
{
	...
	CHECK(kf.GetDelta(24) == Catch::Detail::Approx(-0.1622f).margin(0.0001));

	CHECK(kf.GetLong(390) == 100);
	CHECK(kf.IsIncreasing(390) == false);
	CHECK(kf.GetDelta(390) == Catch::Detail::Approx(-0.0732f).margin(0.0001));

	CHECK(kf.GetLong(391) == 100);
	CHECK(kf.IsIncreasing(391) == false);
	CHECK(kf.GetDelta(388) == Catch::Detail::Approx(-0.0886f).margin(0.0001));
}
...
TEST_CASE( "Keyframe scaling", "[libopenshot][keyframe]" )
{
	...
	// Spot check values from the curve
	CHECK(kf.GetValue(1) == Catch::Detail::Approx(1.0f).margin(0.01));
	CHECK(kf.GetValue(24) == Catch::Detail::Approx(7.99f).margin(0.01));
	CHECK(kf.GetValue(25) == Catch::Detail::Approx(8.0f).margin(0.01));
	CHECK(kf.GetValue(40) == Catch::Detail::Approx(3.85f).margin(0.01));
	CHECK(kf.GetValue(49) == Catch::Detail::Approx(2.01f).margin(0.01));
	CHECK(kf.GetValue(50) == Catch::Detail::Approx(2.0f).margin(0.01));
	...
	// Spot check values from the curve
	CHECK(kf.GetValue(1) == Catch::Detail::Approx(1.0f).margin(0.01));
	CHECK(kf.GetValue(24) == Catch::Detail::Approx(4.08f).margin(0.01));
	CHECK(kf.GetValue(25) == Catch::Detail::Approx(4.36f).margin(0.01));
	CHECK(kf.GetValue(40) == Catch::Detail::Approx(7.53f).margin(0.01));
	CHECK(kf.GetValue(49) == Catch::Detail::Approx(7.99f).margin(0.01));
	CHECK(kf.GetValue(50) == Catch::Detail::Approx(8.0f).margin(0.01));
	CHECK(kf.GetValue(90) == Catch::Detail::Approx(2.39f).margin(0.01));
	CHECK(kf.GetValue(100) == Catch::Detail::Approx(2.0f).margin(0.01));
...
TEST_CASE( "flip Keyframe", "[libopenshot][keyframe]" )
{
	...
	CHECK(kf.GetValue(25) == Catch::Detail::Approx(8.0f).margin(0.01));
	CHECK(kf.GetValue(50) == Catch::Detail::Approx(2.0f).margin(0.01));
	CHECK(kf.GetValue(100) == Catch::Detail::Approx(10.0f).margin(0.01));

	// Flip the points
	kf.FlipPoints();

	// Spot check values from the curve
	CHECK(kf.GetValue(1) == Catch::Detail::Approx(10.0f).margin(0.01));
	CHECK(kf.GetValue(25) == Catch::Detail::Approx(2.0f).margin(0.01));
	CHECK(kf.GetValue(50) == Catch::Detail::Approx(8.0f).margin(0.01));
	CHECK(kf.GetValue(100) == Catch::Detail::Approx(1.0f).margin(0.01));
...
TEST_CASE( "remove duplicate Point", "[libopenshot][keyframe]" )
{
	...
	CHECK(kf.GetPoint(0).co.Y == Catch::Detail::Approx(2.0).margin(0.01));
}
...
TEST_CASE( "large number values", "[libopenshot][keyframe]" )
{
	...
	CHECK(kf.GetPoint(0).co.Y == Catch::Detail::Approx(1.0).margin(0.01));
	CHECK(kf.GetPoint(1).co.Y == Catch::Detail::Approx(100.0).margin(0.01));
}
...
TEST_CASE( "use segment end point interpolation", "[libopenshot][keyframe]" )
{
	...
	CHECK(f.GetValue(50) == Catch::Detail::Approx(75.9).margin(0.1));
}
...
TEST_CASE( "handle large segment", "[libopenshot][keyframe]" )
{
	...
	CHECK(kf.GetValue(500000) == Catch::Detail::Approx(0.5).margin(0.01));
...
TEST_CASE( "std::vector<Point> constructor", "[libopenshot][keyframe]" )
{
	...
	CHECK(k1.GetValue(10) == Catch::Detail::Approx(30.0f).margin(0.0001));
}
...
TEST_CASE( "TrackedObjectBBox init", "[libopenshot][keyframe]" )
{
    ...
    CHECK(kfb.stroke_alpha.GetValue(1) == Catch::Detail::Approx(0.7f).margin(0.0001));
